...
Calendar.prototype.create = function() {
	...
	var today = new Date();
	//var buttonText = "今天";
    var buttonText = this._todayButtonLabel;
	//today.getDate() + " " + this._monthNames[today.getMonth()] + ", " + today.getFullYear();
...
Calendar.prototype.setTodayButtonLabel = function(v) {
  this._todayButtonLabel = v;
}
...
Calendar.prototype.initialize = function(monthNames, shortMonthNames, weekDayNames, shortWeekDayNames, format,
  firstDayOfWeek, includeWeek, minimalDaysInFirstWeek, todayButtonLabel, clearButtonLabel)
{
  ...
  this.setTodayButtonLabel(todayButtonLabel);
